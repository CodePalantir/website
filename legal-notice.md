...
<section class="py-24 px-6">
    <div class="max-w-4xl mx-auto">
        <div class="prose prose-lg max-w-none">
            ...
            <h2 class="text-3xl font-bold text-slate-900 mb-6">Disclaimer</h2>
            ...
            <h3 class="text-2xl font-bold text-slate-900 mb-4 mt-8">Liability for Links</h3>
            <div class="bg-slate-50 p-8 rounded-2xl mb-8">
                <p class="text-slate-600 leading-relaxed mb-4">
            ...
            <h3 class="text-2xl font-bold text-slate-900 mb-4 mt-8">Data Protection</h3>
            <div class="bg-slate-50 p-8 rounded-2xl mb-12">
                ...
                <p class="text-slate-600 leading-relaxed mt-4">
                    For more detailed information about how we handle your personal data, please refer to our <a href="/privacy" class="text-purple-600 hover:text-purple-700 transition-colors font-semibold">Privacy Policy</a>.
                </p>
            </div>
